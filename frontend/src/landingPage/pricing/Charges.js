...
function Charges() {
  return (
    <div className="container p-5">
      <div className="row">
        <div className="col-6 text-muted" style={{ fontSize: "0.80rem" }}>
          <h3 className="mb-5">Charges Explained</h3>
          <p className="fs-6" style={{ fontWeight:'500' }}>Securities/Commodities transaction tax</p>
          <p>
          ...
          <p className="fs-6" style={{ fontWeight:'500' }}>Transaction/Turnover Charges</p>
          <p>
          ...
          <p className="fs-6" style={{ fontWeight:'500' }}>Call & trade</p>
          <p>
            Additional charges of ₹50 per order for orders placed through a
            dealer at Zerodha including auto square off orders.
          </p>
          <p className="fs-6" style={{ fontWeight:'500' }}>Stamp charges</p>
          <p>
          ...
          <p className="fs-6" style={{ fontWeight:'500' }}>NRI brokerage charges</p>
          <p>
            <ul>
              <li>
          ...
          <p className="fs-6" style={{ fontWeight:'500' }}>Account with debit balance</p>
          <p>
            If the account is in debit balance, any order placed will be charged
            ₹40 per executed order instead of ₹20 per executed order.
          </p>
          <p className="fs-6" style={{ fontWeight:'500' }}>Charges for Investor's Protection Fund Trust (IPFT) by NSE</p>
          <p>
            <ul>
              <li>
          ...
          <p className="fs-6" style={{ fontWeight:'500' }}>Margin Trading Facility (MTF)</p>
          <p>
            <ul>
              <li>
        ...
        <div className="col-6 mt-5 text-muted" style={{ fontSize: "0.80rem" }}>
          <p className="fs-6 mt-4" style={{ fontWeight:'500' }}>GST</p>
          <p>
            Tax levied by the government on the services rendered. 18% of (
            brokerage + SEBI charges + transaction charges)
          </p>
          <p className="fs-6" style={{ fontWeight:'500' }}>SEBI Charges</p>
          <p>
            Charged at ₹10 per crore + GST by Securities and Exchange Board of
            India for regulating the markets.
          </p>
          <p className="fs-6" style={{ fontWeight:'500' }}>DP (Depository participant) charges</p>
          <p>
          ...
          <p className="fs-6" style={{ fontWeight:'500' }}>Pledging charges</p>

          <p>₹30 + GST per pledge request per ISIN.</p>

          <p className="fs-6" style={{ fontWeight:'500' }}> AMC (Account maintenance charges)</p>
          ...
          <p>
            ...
            (90 days). To learn more about AMC, Click here</p>
            <p className="fs-6" style={{ fontWeight:'500' }}>Corporate action order charges</p>
            <p>
              ₹20 plus GST will be charged for OFS / buyback / takeover /
              delisting orders placed through Console.
            </p>
            <p className="fs-6" style={{ fontWeight:'500' }}>Off-market transfer charges</p>
            <p>₹25 per transaction.</p>
            <p className="fs-6" style={{ fontWeight:'500' }}>Physical CMR request</p>
            <p>
              First CMR request is free. ₹20 + ₹100 (courier charge) + 18% GST
              for subsequent requests.
            </p>
           <p className="fs-6" style={{ fontWeight:'500' }}>Payment gateway charges</p>
          

          <p>₹9 + GST (Not levied on transfers done via UPI)</p>

          <p className="fs-6" style={{ fontWeight:'500' }}>Delayed Payment Charges</p>
          ...
          <p className="fs-6" style={{ fontWeight:'500' }}>Trading using 3-in-1 account with block functionality</p>
          <p>
            <ul>
        ...
        <h5 className="mt-4 text-muted" style={{ fontSize: "1.30rem" }}>Disclaimer</h5>
        <p className="text-muted mt-3 mb-5" style={{ fontSize: "0.80rem", letterSpacing:'0.1px',lineHeight:'1.5rem' }}>
