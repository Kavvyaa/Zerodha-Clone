        ...
        <div className="container">
            ...
            <div className="row text-center">
                <div className="col-4 p-5">
                    <img src="Media/images/pricingEquity.svg" alt="equity" width={'90%'} className="img-fluid"/>
                ...
                <div className="col-4 p-5">
                    <img src="Media/images/intradayTrades.svg" alt="trades" width={'90%'} className="img-fluid"/>
                ...
                <div className="col-4 p-5">
                    <img src="Media/images/pricingEquity.svg" alt="pricing equity" width={'90%'} className="img-fluid"/>
