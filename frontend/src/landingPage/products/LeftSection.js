      ...
      <div className="container mb-5">
        <div className="row">
          <div className="col-lg-7 mt-5">
            <img src={imageUrl} className="img-fluid mt-5" />
          </div>
          <div className="col-lg-4 offset-lg-1" style={{marginTop:"150px"}}>
            ...
            <br />
            <a href={googlePlay} >
              <img src="Media/images/googlePlayBadge.svg" className="mt-4" width={'40%'} />
            </a>
            &nbsp; &nbsp;
            <a href={appStore}>
              <img src="Media/images/appstoreBadge.svg" className="mt-4 " width={'35%'}/>
            </a>
          </div>
        </div>
