    ...
    return ( 
        <div className="container text-center text-muted">
            ...
            <div className="row p-5">
                <div className="col-4">
                    <img src="Media/images/zerodhaFundhouse.png" alt="fundhouse" width={'60%'}/>
                ...
                <div className="col-4">
                    <img src="Media/images/sensibullLogo.svg" alt="sensibull" width={'75%'}/>
                ...
                <div className="col-4">
                    <img src="Media/images/tijori.svg" alt="tijori" width={'50%'}/>
            ...
            <div className="row p-5">
                <div className="col-4 mb-5">
                    <img src="Media/images/streakLogo.png" alt="streak" width={'40%'}/>
                ...
                <div className="col-4">
                    <img src="Media/images/dittoLogo.png" alt="ditto" width={'40%'}/>
