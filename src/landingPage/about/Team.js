        ...
        <div className="container">
            ...
            <div className="row">
                ...
                <div className="col-5 p-5 text-center">
                    <img src="Media/images/nithinKamath.jpg" alt="ceo images" style={{borderRadius:'100%', width: '80%'}}/>
            ...
            <div className="row text-center">
                <div className="col-4 p-5">
                    <img src="Media/images/Nikhil.jpg" style={{borderRadius:'100%', width: '80%'}} />
                    <h5 className="mt-3 text-muted">Nikhil Kamath</h5>
                    <h6 className="mt-3 text-muted">Co-founder, CFO</h6>
                </div>
                <div className="col-4 p-5">
                    <img src="Media/images/Kailash.jpg" style={{borderRadius:'100%', width: '80%'}}/>
                    <h5 className="mt-3 text-muted">Dr. Kailash Nadh</h5>
                    <h6 className="mt-3 text-muted">CTO</h6>
                </div>
                <div className="col-4 p-5">
                    <img src="Media/images/Venu.jpg" style={{borderRadius:'100%', width: '80%'}}/>
            ...
            <div className="row text-center mb-5">
                <div className="col-4 p-5">
                    <img src="Media/images/Seema.jpg" style={{borderRadius:'100%', width: '80%'}}/>
                    <h5 className="mt-3 text-muted">Seema Patil</h5>
                    <h6 className="mt-3 text-muted">Director</h6>
                </div>
                <div className="col-4 p-5">
                    <img src="Media/images/Karthik.jpg" style={{borderRadius:'100%', width: '80%'}}/>
                    <h5 className="mt-3 text-muted">Karthik Rangappa</h5>
                    <h6 className="mt-3 text-muted">Chief of Education</h6>
                </div>
                <div className="col-4 p-5 ">
                    <img src="Media/images/Austin.jpg" style={{borderRadius:'100%', width: '80%'}}/>
